...
namespace LythuyetCS
{
    ...
    class Bai10
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bài 10: Sắp xếp sinh viên ");
            Console.WriteLine("---------------------------------------------------------------");
            ...
            Console.WriteLine("---------------------------------------------------------------");
            Console.WriteLine("Danh sách sinh viên có điểm sắp xếp giảm dần: ");
            var sapxep = students.OrderByDescending(i => i.Score);
            foreach (Student s in sapxep)
            {
