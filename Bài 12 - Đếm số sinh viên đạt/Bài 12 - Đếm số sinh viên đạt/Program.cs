...
namespace LythuyetCS
{
    ...
    class Bai12
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bài 12: Đếm số sinh viên đạt ");
            Console.WriteLine("---------------------------------------------------------------");
            ...
            Console.WriteLine("---------------------------------------------------------------");
            Console.WriteLine("Danh sách sinh viên đạt (Điểm >= 7): ");
            var sinhvien = students.Where(i => i.Score >= 7);
            int dem = 0;
            ...
            Console.WriteLine("Số sinh viên đạt: {0}", dem);
            Console.ReadLine();
        }
    }
}